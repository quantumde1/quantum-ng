...
set-compiler-x86:
	$(eval ARCH := x86)
	$(eval CC_FLAGS := -g -m32 -isystem $(IDIR) -I include -DKERNEL=1 -fno-stack-protector -fno-pie)
	$(eval CC_USER_FLAGS := -g -m32 -isystem $(IDIR) -I include -fno-stack-protector -fno-pie)
	$(eval AS_FLAGS := -g --32)
